 ...
 */
package com.mycompany.ejemploambitoobjeto;
...
public class ServletScope2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<br>");
            //pasar info a ServletScope3
            out.println("Pulse <a href=\"./ServletScope3\">aquí </a> para pasar a ver los atributos a la siguiente página. <br>");
            out.println("</body>");
            out.println("</html>");
        }
    }
