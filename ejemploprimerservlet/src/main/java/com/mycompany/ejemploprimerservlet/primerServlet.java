...
public class primerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<br>");
            out.println("<b>Server Info: </b>" + request.getServletContext().getServerInfo());
            out.println("<br>");
            out.println("<b>Remote addr: </b>" + request.getRemoteAddr());
            out.println("<br>");
            out.println("<b>Remote Host: </b>" + request.getRemoteHost());
            out.println("<br>");
            out.println("<b>Local: </b>" + request.getLocale());
            out.println("<br>");
            out.println("<b>Default Response Buffer: </b>" + response.getBufferSize());
            out.println("<br>");
            out.println("<b>Request Secure: </b>" + request.isSecure());
            out.println("<br>");
            out.println("<b>HTTP Methos: </b>" + request.getMethod());
            out.println("<br>");
            out.println("<b>Rquest URI: </b>" + request.getRequestURI());
            out.println("<br>");
